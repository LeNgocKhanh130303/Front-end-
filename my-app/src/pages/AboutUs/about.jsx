      ...
      <Row xl={12} className="mt-5">
        <Col sm={4}>
          <div className="feature  text-dark">
            <center>
              <img className="icon" src="https://e7.pngegg.com/pngimages/191/780/png-clipart-computer-icons-online-chat-face-to-face-communication-white-face.png"></img>
            </center>
        ...
        <Col sm={4}>
          <div className="feature">
            <center>
              <img className="icon" src="https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png"></img>
            </center>
